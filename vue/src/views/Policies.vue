<template>
  <div>
    <v-row>
      <v-col
        cols="6"
        v-for="(item, i) in policyItemsSorted"
        :key="'policy' + i"
      >
        <v-card outlined :href="item.link" target="_blank">
...
export default {
      ...
      policyItems: [
        {
          ...
          link: 'https://newbradwellpc-my.sharepoint.com/personal/clerk_newbradwell-pc_gov_uk/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fclerk%5Fnewbradwell%2Dpc%5Fgov%5Fuk%2FDocuments%2FClerk%20Laptop%2FDocuments%2FMeetings%2F2020%2D2021%2FMinutes%2FMinutes'
        },
        {
          title: 'Parish Council Meeting Agendas',
          desc: 'This archive contains agenda (and any applicable resources) documents.',
          link: 'https://newbradwellpc-my.sharepoint.com/personal/clerk_newbradwell-pc_gov_uk/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fclerk%5Fnewbradwell%2Dpc%5Fgov%5Fuk%2FDocuments%2FClerk%20Laptop%2FDocuments%2FMeetings%2F2020%2D2021%2FAgenda%2FAgenda'
        },
        {
        ...
        },
        {
          ...
          desc: 'Here are our Model Standing Orders, last updated June 2021.',
          link: '/docs/standing-orders-jun21.pdf'
        },
        {
  ...
  computed: {
    policyItemsSorted: function () {
      const out = []
      const map = {}
      const names = []
      for (const item of this.policyItems) {
